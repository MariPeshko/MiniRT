...
void test_ambient(void)
{
    ...
    if (parse_delegate(valid_ambient_low) != 0) printf("Failed test valid_ambient_low\n");
    if (parse_delegate(valid_ambient_middle) != 0) printf("Failed test valid_ambient_middle\n");
    if (parse_delegate(valid_ambient_high) != 0) printf("Failed test valid_ambient_high\n");
